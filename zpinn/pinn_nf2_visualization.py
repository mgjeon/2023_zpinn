...
# %% auto 0
__all__ = ['create_physical_coordinates', 'pinn_cube', 'draw_grid', 'draw_grid_new']
...
from .pinn_nf2_cleanup import create_coordinates
...
# %% ../nbs/06_PINN_NF2_visualization.ipynb 16
class draw_grid_new:
    def __init__(self, grd):
        grid = copy.deepcopy(grd)
        self.grid = grid
