# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/02_lowlou_mag.ipynb.

# %% auto 0
__all__ = ['LowLouMag']

# %% ../nbs/02_lowlou_mag.ipynb 2
import numpy as np
