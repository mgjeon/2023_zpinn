# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/35_SPINN_series_trainer.ipynb.

# %% auto 0
__all__ = ['hvp_fwdfwd', 'update_model', 'SPINN3d', 'generate_train_data', 'generate_train_data_random', 'curlx', 'curly',
           'curlz', 'apply_model_spinn', 'apply_model_spinn_random', 'spinn_cube', 'SPINN_series_Trainer']

# %% ../nbs/35_SPINN_series_trainer.ipynb 2
import jax 
...
# %% ../nbs/35_SPINN_series_trainer.ipynb 3
...
# %% ../nbs/35_SPINN_series_trainer.ipynb 4
...
# %% ../nbs/35_SPINN_series_trainer.ipynb 5
...
# %% ../nbs/35_SPINN_series_trainer.ipynb 6
...
# %% ../nbs/35_SPINN_series_trainer.ipynb 7
...
# %% ../nbs/35_SPINN_series_trainer.ipynb 8
@partial(jax.jit, static_argnums=(0,))
...
# %% ../nbs/35_SPINN_series_trainer.ipynb 9
...
# %% ../nbs/35_SPINN_series_trainer.ipynb 11
import pyvista as pv
import pickle
from .mag_viz import create_coordinates

# %% ../nbs/35_SPINN_series_trainer.ipynb 12
class spinn_cube:
...
# %% ../nbs/35_SPINN_series_trainer.ipynb 13
from .potential_field import cal_and_save_potential_boundary_for_spinn
from pathlib import Path
import matplotlib.pyplot as plt
import logging

# %% ../nbs/35_SPINN_series_trainer.ipynb 14
class SPINN_series_Trainer:
    ...
    def setup(self, b_bottom_list):
        ...
        spinn_output_path = os.path.join(Path(b_bottom_path).parent.parent, 'SPINN')
        Path(spinn_output_path).mkdir(parents=True, exist_ok=True)
        self.spinn_output_path = spinn_output_path
    ...
    def train(self):
        ...
        spinn_output_path = self.spinn_output_path
            ...
            if not os.path.exists(final_params_path):
                ...
                for e in trange(1, series_total_iterations + 1):
                    ...
                    if e % series_log_iterations == 0:
                        logger.info(f'Epoch: {e}/{series_total_iterations} --> total loss: {loss:.8f}')
