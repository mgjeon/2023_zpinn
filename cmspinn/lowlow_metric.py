# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/19_LowLou_metric.ipynb.

# %% auto 0
__all__ = ['vector_norm', 'divergence', 'curl', 'metrics', 'metric_df']

# %% ../nbs/19_LowLou_metric.ipynb 3
import numpy as np 
import pandas as pd

# %% ../nbs/19_LowLou_metric.ipynb 4
